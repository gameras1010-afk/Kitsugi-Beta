...
Java_com_kitsugi_animelist_core_player_DoviBridge_nativeGetBridgeVersion(JNIEnv* env, jclass /* clazz */) {
#if DOVI_REAL_LINKED
...
Java_com_kitsugi_animelist_core_player_DoviBridge_nativeIsConversionPathReady(
    JNIEnv* /* env */,
    jclass /* clazz */
) {
#if DOVI_REAL_LINKED
...
Java_com_kitsugi_animelist_core_player_DoviBridge_nativeConvertDv7RpuToDv81(
    JNIEnv* env,
    jclass /* clazz */,
    jbyteArray payload,
    jint mode
...
Java_com_kitsugi_animelist_core_player_DoviBridge_nativeConvertDv7RpuToDv81NonAllocating(
    JNIEnv* env,
    jclass /* clazz */,
    jbyteArray sample,
    jint offset,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_kitsugi_animelist_core_player_DoviBridge_nativeProcessVideoSample(
    JNIEnv* env,
    jclass /* clazz */,
    jbyteArray sample,
    jint sampleLen,
