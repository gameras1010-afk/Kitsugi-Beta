package com.kitsugi.animelist.ui.tv.input
...
@Composable
fun rememberLongPressKeyTracker(): LongPressKeyTracker =
    remember { LongPressKeyTracker() }

/**
 * Tracks SELECT / DPAD_CENTER long-presses on TV remote controls.
 * Wire into [Modifier.onPreviewKeyEvent] to detect long-press for context menus.
 */
...
/**
 * Checks if a key code corresponds to a selection action (DPAD_CENTER, ENTER).
 */
