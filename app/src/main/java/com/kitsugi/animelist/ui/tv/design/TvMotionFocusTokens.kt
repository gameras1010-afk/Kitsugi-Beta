...
@Immutable
data class KitsugiMotionDurations(
    val instant: Int,
    val quick: Int,
    val fast: Int,
    val medium: Int,
...
@Immutable
data class KitsugiMotionEasings(
    val standard: Easing,
...
@Immutable
data class KitsugiMotionTokens(
    val durations: KitsugiMotionDurations,
    val easings: KitsugiMotionEasings,
...
object KitsugiMotion {
    val tokens = KitsugiMotionTokens(
        durations = KitsugiMotionDurations(
            instant = 0,
            quick = 125,
            fast = 180,
            medium = 350,
