...
object DolbyVisionBaseLayerPolicy {
    ...
    fun resolveFromCapabilities(
        ...
        val decision = when {
            ...
            // RPU to DV8.1 (mode 1 / ToMel by default) and the chip decodes 8.1 and emits DV.
            ...
            // Samsung HDR10 fallback: no DV display but a DV81 decoder is available.
            // Convert DV7 to DV81 so the decoder emits HDR10.
