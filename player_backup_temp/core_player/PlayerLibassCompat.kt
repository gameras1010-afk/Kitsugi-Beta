...
import com.kitsugi.animelist.core.player.dvmkv.MatroskaExtractor as DvMatroskaExtractor
...
/**
 * T1.10 – PlayerLibassCompat
 *
 * ExoPlayer'a ASS/SSA altyazı desteğini entegre etmek için yardımcı fonksiyonlar.
 * Peerless2012'nin `ass-media` kütüphanesini kullanarak native libass wrapper'ını başlatır,
 * `KitsugiAssMatroskaExtractor`'ı MatroskaExtractor ve DvMatroskaExtractor yerine inject eder.
 */
    ...
    return ExtractorsFactory {
        ...
        extractors.forEachIndexed { index, extractor ->
            if (extractor is MatroskaExtractor) {
                extractors[index] = KitsugiAssMatroskaExtractor(subtitleParserFactory, assHandler)
            }
