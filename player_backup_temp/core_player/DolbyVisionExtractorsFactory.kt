 ...
 * [com.kitsugi.animelist.core.player.dvmkv.MatroskaExtractor], which surfaces the RPU through
...
private class NativeOptimizedVideoTrackOutput(
    ...
    override fun format(format: Format) {
        ...
        if (stripDvRpu && outFormat.sampleMimeType == MimeTypes.VIDEO_DOLBY_VISION) {
