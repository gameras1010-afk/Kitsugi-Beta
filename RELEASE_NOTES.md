...
### 🔄 Güncelleme Ekranında Mevcut Sürüm Gösterimi (Update Dialog Version Flow)
- **Mevcut Sürüm Bilgisi**: Güncelleme penceresinde kullanıcının o anki mevcut uygulama sürümü de gösterilerek sürüm geçişi (`v[Mevcut Sürüm] < v[Yeni Sürüm]`) şeklinde görünür hale getirildi.
...
### 🔧 Profil Ekranı Kapsamlı Düzeltmeler (v2.4.45)
...
### 🔄 Update Dialog Version Flow
- **Current Version Display**: Added the current app version display to the update dialog, showing the update path as `v[Current Version] < v[New Version]` for clarity.
...
### 🔧 Profile Section Comprehensive Fixes (v2.4.45)
